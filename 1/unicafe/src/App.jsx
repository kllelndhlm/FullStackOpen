    ...
    return (
      ...
      return (
        ...
        <table>
          ...
          <StatisticLine text="average" value ={(props.stats[0] * 1 + props.stats[2] * (-1)) / (props.stats[0] + props.stats[1] + props.stats[2])} />
          <StatisticLine text="positive"  value ={100 * props.stats[0] / (props.stats[0] + props.stats[1] + props.stats[2]) + " %"} />
          </tbody>
        </table>
        </div>
      )
